...
describe("Shape", () => {
    describe("checkShape-Circle", () => {
        it("Should return the rendered circle logo.", () => {
            const shape = new Shapes.Shape();
            expect(shape.checkShape("Circle")).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
    <circle cx="150" cy="100" r="80" fill="#B11226" />
    <text x="50%" y="55%" font-size="60" text-anchor="middle" fill="#1C1C1C">AHA</text>
</svg>`)
        });
    });
    describe("checkShape-Triangle", () => {
        it("Should return the rendered circle logo.", () => {
            const shape = new Shapes.Shape();
            expect(shape.checkShape("Triangle")).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
    <polygon points="150, 18 244, 182 56, 182" fill="#FFCE00" />
    <text x="50%" y="65%" font-size="50" text-anchor="middle" fill="#000000">FR</text>
</svg>`)
        });
    });
    describe("checkShape-Square", () => {
        it("Should return the rendered circle logo.", () => {
            const shape = new Shapes.Shape();
            expect(shape.checkShape("Square")).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
